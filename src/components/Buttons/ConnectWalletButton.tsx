            ...
            >
              {(() => {
                if (!connected) {
                  return (
                    <button
                      className="w-full py-2.5 text-sm mx-auto text-white px-8 font-medium  text-center transition rounded-lg cursor-pointer bg-gradient-to-r from-[#344DBF] to-[#3098FF] hover:opacity-80"
