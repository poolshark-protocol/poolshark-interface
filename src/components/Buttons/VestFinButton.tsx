...
export default function VestFinButton({
  ...
  const { data: bondApprovalData, refetch: refetchBondApproval } =
    useContractRead({
      address: tellerAddress,
      abi: bondTellerABI,
  ...
  const { data: exchangeData, write: exchangeWrite } =
    useContractWrite(exchangeConfig);

  const { config: approvalConfig } = usePrepareContractWrite({
    address: tellerAddress,
    abi: bondTellerABI,
    functionName: "setApprovalForAll",
    args: [vFinAddress, true],
    chainId: chainId,
