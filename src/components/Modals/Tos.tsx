...
export default function TermsOfService({
  ...
  const handleScroll = () => {
    ...
    if (modal) {
      const isScrolledToBottom = modal.scrollHeight - modal.scrollTop === modal.clientHeight;
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            {!read && ( <h2 className="text-sm text-grey1">Please accept these terms before using our services.</h2>)}
             ...
             <p className="text-xs mt-1 text-white/60">All APYs listed on this site are for guidance purposes only. Poolshark employs strategies across a broad range of markets. The available liquidity in said markets changes constantly. As a result, Poolshark cannot calculate APYs in real time. Users acknowledge this and also acknowledge the risk of negative returns on their deposited funds during certain time periods. By depositing funds in Poolshark&apos;s vaults, the user assumes any associated risk of loss.</p>
             </div>
             <div className="mt-5">
             <h1 className="text-sm">Risk of loss of funds when using our products</h1>
             <p className="text-xs mt-1 text-white/60">Our products are a smart contracts based suite of technologies that relies on blockchain technology. By depositing your funds into our vaults you recognize and assume all risks inherent in such technologies, including but not limited to the risk that the smart contracts underlying our vaults could fail, resulting in a total loss of user funds. Poolshark is not responsible for any such losses.</p>
             </div>
             <div className="mt-5">
             <h1 className="text-sm">UI usage and legal jurisdictions</h1>
             <p className="text-xs mt-1 text-white/60">Our Interface is NOT offered to persons or entities who reside in, are citizens of, are incorporated in, or have a registered office in the United States of America or any Prohibited Localities. Poolshark is a decentralized finance project and does not hold any securities licenses in the U.S. or any other jurisdiction. Any investment made through our protocol shall be made with this in mind.</p>
             </div>
             <div className="mt-5">
