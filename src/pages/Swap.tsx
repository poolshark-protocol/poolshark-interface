...
export default function Swap() {
  ...
  return (
    <div className="pt-[10vh] mb-[10vh] px-3 md:px-0 w-full">
      ...
      {LimitActive && (
        <div className="pt-10 pb-20 w-full max-w-2xl mx-auto ">
          <div className="flex items-center justify-between mb-5">
        <h1 className=" ">Limit Orders</h1>
        <button className="text-xs px-5 py-2 bg-red-900 border-red-500 border rounded-lg">Cancel All Orders</button>
        </div>
        <div className="">
          <table className="w-full table-auto ">
            <thead className="">
              <tr className="text-xs text-grey">
                <th className="text-left font-light">Sell</th>
                <th className="text-left font-light">Buy</th>
                <th className="text-left font-light md:block hidden">Price</th>
                <th className="text-left font-light">Date</th>
                <th className="text-left font-light">Status</th>
                <th className="text-right font-light"></th>
              </tr>
            </thead>
            <tbody className="">
            <tr className="h-2"></tr>
            <tr className="text-right cursor-pointer text-xs md:text-sm h-12 ">
        <td className="">
          <div className="text-left flex items-center gap-x-2">
            <img className="md:w-[30px] md:h-[30px] w-[20px] h-[20px]" src="/static/images/eth_icon.png" />
        ...
        <td>
          <div className="text-left flex items-center gap-x-2">
            <img className="md:w-[30px] md:h-[30px] w-[20px] h-[20px]" src="/static/images/dai_icon.png" />
            <div className="flex flex-col text-xs">
              <span className="opacity-60">DAI</span>
              <span>2000</span>
            </div>
            </div>
        </td>
        <td>
          ...
          <div className="flex items-center gap-x-1"><span className="text-grey">1 ETH =</span> 1500 DAI</div>
          <div className="flex items-center gap-x-1"><span className="text-grey">1 DAI =</span> 0.0006 ETH </div>
          </div>
        </td>
        ...
        <td className="">
        <div className="flex relative bg-transparent items-center justify-center h-6 border-grey1 z-40 border rounded-lg gap-x-2 w-full text-xs">
            <div className={`bg-white h-full absolute left-0 z-0 rounded-l-[7px] opacity-10 w-[0%]`} />
            <div className="z-20 ">0% Filled</div>
          </div>
        </td>
        <td className="pl-5">
