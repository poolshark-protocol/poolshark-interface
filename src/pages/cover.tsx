  ...
  return (
    <div className="bg-[url('/static/images/background.svg')] bg-no-repeat bg-cover min-h-screen font-Satoshi ">
      ...
      <div className="flex justify-center w-full text-white relative min-h-[calc(100vh-76px)] w-full">
        <div className="lg:w-[70rem] w-full px-3 absolute bottom-0">
          <div className="flex justify-between mb-6 items-end">
            ...
            <div className="bg-black w-full md:w-2/3 border border-grey2 w-full rounded-t-xl p-6 gap-y-4">
            ...
            <div className="md:hidden block flex w-full space-x-8">
            {create ?
            <div className="bg-black w-full md:w-2/3 border border-grey2 w-full rounded-t-xl p-6 gap-y-4 h-[73vh]">
              {selectedPool != undefined && state != 'initial' ? (
                <CreateCover query={router.query} goBack={handleDiselectPool} />
              ) : (
                <Initial query={router.query} />
