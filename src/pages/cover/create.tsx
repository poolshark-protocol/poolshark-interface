  ...
  return (
    <div className="bg-black min-h-screen  ">
      ...
      <div className="text-white flex flex-col mx-auto max-w-2xl  justify-center pt-10">
        <h1 className="uppercase">{shifted === 'initial' ? "Select an option" : "Create Cover Position "}</h1>
        <div className="mt-6 rounded-[4px] overflow-hidden border border-grey/70">
          <div className="bg-[url('/static/images/bg/shark2.png')] bg-no-repeat bg-cover w-full flex items-center justify-center">
            <button onClick={() => setIsOpen(true)} className="px-24 py-6 mx-auto disabled:cursor-not-allowed cursor-pointer text-center transition mx-auto my-12 border border-main bg-main1/50 uppercase backdrop-blur shadow-lg text-sm disabled:opacity-50 hover:opacity-80">
              COVER EXISTING POOL
            </button>
            </div>   
            <div className="bg-[url('/static/images/bg/shark3.png')] bg-no-repeat bg-cover w-full flex items-center justify-center">
            <button onClick={() => setIsShifted('createCover')} className="px-24 py-6 mx-auto disabled:cursor-not-allowed cursor-pointer text-center transition mx-auto my-12 border border-grey bg-black/50 backdrop-blur uppercase shadow-lg text-sm disabled:opacity-50 hover:opacity-80">
              CREATE CUSTOM COVER
            </button>
            </div>  
        </div>
