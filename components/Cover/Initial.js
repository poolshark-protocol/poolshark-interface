        ...
        <div className="opacity-50 cursor-not-allowed">
              ...
              <div className="flex justify-between w-full gap-x-6">
                ...
                <div className="flex justify-center items-center">
                  ...
                  <input className="bg-[#0C0C0C] py-2 outline-none text-center w-full" placeholder="0" disabled/>
                  <div className="border border-grey1 text-grey flex items-center h-7 w-7 justify-center rounded-lg text-white ">
              ...
              <div className="mt-6" >
                <div
          className="w-full py-4 mx-auto font-medium text-center transition rounded-xl  bg-gradient-to-r from-[#344DBF] to-[#3098FF] hover:opacity-80"
        >
          Create Cover
        </div>
        </div>
